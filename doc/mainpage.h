/*! \mainpage TSunmix
 *
 * \section About TSunmix
 *
 * TSunmix is tool for extraction files from Tiberian sun's mix archive. 
 * 
 * \section Licence
 *
 ...
 * \section Credits
 * 
 * TSunmix is based on <a href="http://xhp.xwis.net/documents/MIX_Format.html">mix file format specification</a> by Olaf van der Spek. It's inspired by XCC Utilities. 
 * For list of known file names XCC's global mix database.dat is used.
 * 
